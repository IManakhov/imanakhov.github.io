            ...
            ko.utils = (function() {
                ...
                return {
                    ...
                    registerEventHandler: function(element, eventType, handler) {
                        ...
                        } else if (!mustUseAttachEvent && typeof element.addEventListener == "function") element.addEventListener(eventType, wrappedHandler, false);
                ...
                ko.templateSources.domElement.prototype['nodes'] = function( /* valueToWrite */ ) {
                    ...
                    if (arguments.length == 0) {
                        ...
                        return containerData || (
                                this.templateType === templateTemplate ? element.content : this.templateType === templateElement ? element : undefined);
                    } else {
                        var valueToWrite = arguments[0];
